...
| Idempotent workspace publish | advisory | `docs/specs/SHIPPER-SPEC-0007-idempotent-workspace-publish.md`; `plans/0.4.0/idempotent-workspace-publish.md`; `docs/how-to/publish-missing-workspace-crates.md`; promotion blocked on focused JSON summary + idempotent publish regression suite | cli/integrations |
