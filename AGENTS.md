...
- Do not run `changie merge` until the focused historical changelog catch-up establishes the pre-Changie baseline. See [docs/how-to/manage-changelog-fragments.md](docs/how-to/manage-changelog-fragments.md).
